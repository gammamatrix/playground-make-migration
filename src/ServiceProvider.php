...
namespace Playground\Make\Migration;
...
class ServiceProvider extends AuthServiceProvider
{
    ...
    public string $package = 'playground-make-migration';
    ...
    public function register(): void
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/config/playground-make-migration.php',
    ...
    public function about(): void
    {
        ...
        AboutCommand::add('Playground: Make Migration', fn () => [
